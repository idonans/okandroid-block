...
import com.okandroid.block.widget.FitInsetsSpace;

public class FitUntopInsetsToParent extends FitInsetsSpace {
  ...
  @Override protected Rect onFitInsets(int left, int top, int right, int bottom) {
