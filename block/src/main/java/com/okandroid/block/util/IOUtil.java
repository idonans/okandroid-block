...
public final class IOUtil {
   ...
   */
  @Deprecated public static void closeQuietly(SQLiteClosable closeable) {
    // ignore
  }
  ...
  public static long copy(InputStream from, OutputStream to, Available available, Progress progress)
      throws Throwable {
    long copy = 0;
  ...
  public static long copy(InputStream from, OutputStream to, long count, Available available,
  ...
  public static long copy(InputStream from, File to, boolean append, Available available,
      Progress progress) throws Throwable {
  ...
  public static String readAsString(InputStream is, long count, Available available,
      Progress progress) throws Throwable {
