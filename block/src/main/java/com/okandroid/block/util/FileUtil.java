...
public class FileUtil {
   ...
   * 不能获得这样一个目录，返回 null.
   */
  @CheckResult public static File getCacheDir() {
   ...
   * 不能获得这样一个目录，返回 null.
   */
  @CheckResult public static File getExternalCacheDir() {
    File cacheDir = ContextUtil.getContext().getExternalCacheDir();
    if (cacheDir == null) {
      return null;
    }
    File processCacheDir = new File(cacheDir, ProcessManager.getInstance().getProcessTag());
   ...
   * 不能获得这样一个目录，返回 null.
   */
  @CheckResult public static File getPublicDCIMDir() {
   ...
   * 不能获得这样一个目录，返回 null.
   */
  @CheckResult public static File getPublicPictureDir() {
   ...
   * 不能获得这样一个目录，返回 null.
   */
  @CheckResult public static File getPublicDownloadDir() {
   ...
   * 不能获得这样一个目录，返回 null.
   */
  @CheckResult public static File getPublicMovieDir() {
   ...
   * 不能获得这样一个目录，返回 null.
   */
  @CheckResult public static File getPublicMusicDir() {
   ...
   * 不能获得这样一个目录，返回 null.
   */
  @CheckResult public static File getPublicDir(String environmentDirectory) {
   ...
   */
  @CheckResult public static String getFileExtensionFromUrl(String url) {
   ...
   */
  @CheckResult public static String getFilenameFromUrl(String url) {
    if (!TextUtils.isEmpty(url)) {
      int fragment = url.lastIndexOf('#');
      if (fragment > 0) {
        url = url.substring(0, fragment);
   ...
   */
  @CheckResult public static File createNewTmpFileQuietly(String prefix, String suffix, File dir) {
    try {
      if (createDir(dir)) {
        if (prefix == null) {
          prefix = "";
   ...
   */
  @CheckResult public static String createSimilarFileQuietly(String path) {
    try {
