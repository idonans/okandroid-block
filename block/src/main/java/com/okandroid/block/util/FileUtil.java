...
public class FileUtil {
    ...
    /**
     * 得到一个在系统拍照目录下，以当前应用标识为子文件夹名的目录(如果目录不存在则尝试创建)。 <br>
     * 不能获得这样一个目录，返回 null.
     */
    @CheckResult
    ...
    /**
     * 得到一个在系统图片目录下，以当前应用标识为子文件夹名的目录(如果目录不存在则尝试创建)。 <br>
     * 不能获得这样一个目录，返回 null.
     */
    @CheckResult
    ...
    /**
     * 得到一个在系统下载目录下，以当前应用标识为子文件夹名的目录(如果目录不存在则尝试创建)。 <br>
     * 不能获得这样一个目录，返回 null.
     */
    @CheckResult
    ...
    /**
     * 得到一个在系统视频目录下，以当前应用标识为子文件夹名的目录(如果目录不存在则尝试创建)。 <br>
     * 不能获得这样一个目录，返回 null.
     */
    @CheckResult
    ...
    /**
     * 得到一个在系统音乐目录下，以当前应用标识为子文件夹名的目录(如果目录不存在则尝试创建)。 <br>
     * 不能获得这样一个目录，返回 null.
     */
    @CheckResult
    ...
    /**
     * 得到一个在指定系统目录下，以当前应用标识为子文件夹名的目录(如果目录不存在则尝试创建)。 <br>
     * 不能获得这样一个目录，返回 null.
     */
    @CheckResult
