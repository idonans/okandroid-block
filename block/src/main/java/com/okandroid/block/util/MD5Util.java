...
public class MD5Util {
  ...
  @NonNull public static String md5FilePath(@Nullable String filePath) {
    try {
  ...
  @NonNull public static String md5(@Nullable File file) {
  ...
  @NonNull public static String md5(@Nullable String str) {
    try {
      if (str == null) {
        return DEFAULT_MD5;
      }
