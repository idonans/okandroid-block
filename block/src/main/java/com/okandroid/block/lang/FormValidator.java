...
public class FormValidator {
    ...
    if (inputViews != null) {
      for (InputView inputView : inputViews) {
        ...
        inputView.setOnContentChangedListener(new InputView.OnContentChangedListener() {
          @Override public void onContentChanged(InputView view) {
            checkFormSubmitStatus(inputViews, submitViews);
          }
        });
      }
  ...
  public static class InputViewFactory {
    ...
    @Nullable public static InputView create(@Nullable CheckBox checkBox) {
      if (checkBox == null) {
        return null;
      }
    ...
    @Nullable public static InputView create(@Nullable TextView textView) {
      if (textView == null) {
        return null;
      }
    ...
    public abstract static class BaseInputView implements InputView {
      ...
      @Override public void setOnContentChangedListener(OnContentChangedListener listener) {
    ...
    public static class TextViewInputView extends BaseInputView {
      ...
      @Override public boolean isContentEnable() {
  ...
  public static class SubmitViewFactory {
    ...
    @Nullable public static SubmitView create(@Nullable View view) {
      if (view == null) {
        return null;
      }
    ...
    public static class SimpleSubmitView implements SubmitView {
      ...
      @Override public void setSubmitEnable(boolean enable) {
        if (mView.isEnabled() != enable) {
          mView.setEnabled(enable);
        }
      }

      @Override public boolean isSubmitEnable() {
