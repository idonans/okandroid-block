...
public class AppEnvironment {
  ...
  public static class AppProperties extends SimpleApplicationCallbacks {
    ...
    public Integer getLogLevel() {
      ...
      if (logLevelInt == null) {
        String logLevel = ContextUtil.getContext().getString(R.string.okandroid_block_log_level);
    ...
    public String getSubDirName() {
      ...
      if (subDirName == null) {
        subDirName = ContextUtil.getContext().getString(R.string.okandroid_block_sub_dir_name);
    ...
    public Boolean isFrescoEnable() {
      ...
      if (frescoEnable == null) {
        frescoEnable = ContextUtil.getContext()
            .getResources()
    ...
    public boolean isFresco565Config() {
      ...
      if (fresco565Config == null) {
        fresco565Config = ContextUtil.getContext()
            .getResources()
  ...
  public interface ApplicationCallbacks
      extends Application.ActivityLifecycleCallbacks, ComponentCallbacks, ComponentCallbacks2 {
  }
  ...
  private static class InternalApplicationCallbacks implements ApplicationCallbacks {
    ...
    private final WeakHashMap<ApplicationCallbacks, Object> mOuterCallbacks = new WeakHashMap<>();
      ...
      if (callbacks != null) {
        for (Object callback : callbacks) {
          if (callback instanceof ApplicationCallbacks) {
            ((ApplicationCallbacks) callback).onActivityCreated(activity, savedInstanceState);
          }
        }
      }
    }
    ...
    @Override public void onActivitySaveInstanceState(Activity activity, Bundle outState) {
      ...
      if (callbacks != null) {
        for (Object callback : callbacks) {
          if (callback instanceof ApplicationCallbacks) {
            ((ApplicationCallbacks) callback).onActivitySaveInstanceState(activity, outState);
          }
        }
      }
    }
